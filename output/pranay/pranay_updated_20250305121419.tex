...
\begin{document}
    ...
    \section{Summary}
Aspiring software engineer specializing in machine learning, computer vision, and robotics, with a robust background in Python, TensorFlow, Keras, and OpenCV. My experience spans developing advanced software solutions and tackling intricate technical issues in artificial intelligence, natural language processing, and system scalability. I am keen to apply my technical expertise and team-oriented mindset in a summer internship, aiming to elevate product capabilities and pioneer cutting-edge software innovations.
\section{Education}
