...
\begin{document}
    ...
    \section{Summary}
Aspiring AI Engineer with a strong foundation in machine learning, computer vision, and robotics, I am proficient in Python, TensorFlow, Keras, and OpenCV. My experience includes tackling complex problems and delivering innovative solutions in artificial intelligence, natural language processing, and scalable software architectures. I am keen to apply my technical expertise and collaborative spirit to a summer internship, aiming to enhance product functionalities and advance cutting-edge software development projects.
\section{Education}
