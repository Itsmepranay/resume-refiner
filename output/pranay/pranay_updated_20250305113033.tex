...
\begin{document}
    ...
    \section{Summary}
Motivated and detail-oriented aspiring software engineer with a strong foundation in machine learning, computer vision, and robotics. Proficient in programming with Python and adept at utilizing frameworks like TensorFlow, Keras, and OpenCV for building and optimizing software applications. While my primary expertise lies in AI and software development, my technical skills are adaptable and applicable to complex technologies including VLSI engineering. I am keen on applying my problem-solving abilities and technical knowledge in a summer internship, aiming to contribute to and enhance product development through innovative solutions. I am enthusiastic about exploring new challenges and eager to apply my background in software engineering to the field of VLSI design and development.
\section{Education}
