...
\begin{document}
    ...
    \section{Summary}
Aspiring AI engineer with a robust background in machine learning, computer vision, and robotics, adept at crafting innovative software solutions using Python, TensorFlow, Keras, and OpenCV. Proficient in tackling complex technical issues, I excel in projects that enhance artificial intelligence capabilities, including natural language processing and scalable technologies. I am keen to apply my technical expertise and collaborative spirit to a role that demands cutting-edge software development and product innovation.
\section{Education}
