...
\begin{document}
    ...
    \section{Summary}
As a dedicated aspiring software engineer with solid knowledge in machine learning, computer vision, and robotics, I possess a strong foundation in developing advanced software applications utilizing Python, TensorFlow, Keras, and OpenCV. My background includes tackling complex technical issues and contributing significantly to projects in artificial intelligence, natural language processing, and the creation of scalable solutions. I am keen to apply my technical expertise and collaborative spirit in a summer internship. My goal is to significantly enhance product functionalities and push the boundaries of innovative software development.
\section{Education}
