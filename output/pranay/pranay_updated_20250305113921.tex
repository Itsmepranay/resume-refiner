...
\begin{document}
    ...
    \section{Summary}
Aspiring software engineer with a strong foundation in machine learning, computer vision, and robotics, seeking a full-time position as an automobile lead engineer. Expert in developing robust software solutions using Python, TensorFlow, Keras, and OpenCV. Proficient in tackling complex technical issues and delivering innovative contributions in artificial intelligence and natural language processing. Committed to utilizing my technical expertise and problem-solving skills to enhance automotive product development and lead cutting-edge software initiatives.
\section{Education}
