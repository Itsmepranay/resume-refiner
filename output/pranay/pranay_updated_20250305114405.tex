...
\begin{document}
    ...
    \section{Summary}
Aspiring AI Engineer with a robust background in machine learning, computer vision, and robotics. Proficient in Python, TensorFlow, Keras, and OpenCV, I excel in developing advanced software solutions and tackling intricate technical problems. My experience spans artificial intelligence, natural language processing, and creating scalable systems. I am keen to apply my technical expertise and teamwork skills in a summer internship, aiming to innovate and enhance software products.
\section{Education}
