...
\begin{document}
    ...
    \section{Summary}
Aspiring software engineer with a strong foundation in machine learning, computer vision, and robotics, seeking to transition into the automotive industry. Proficient in Python, TensorFlow, Keras, and OpenCV, I have developed a range of software solutions that address complex technical challenges. My experience includes working on projects in artificial intelligence, natural language processing, and scalable software development. I am keen to apply my technical expertise and collaborative skills in a full-time role as an automobile lead engineer, aiming to enhance product development and drive innovation in automotive software solutions.
\section{Education}
