...
\begin{document}
    ...
    \section{Summary}
Aspiring software engineer with a robust background in machine learning, computer vision, and robotics. Proficient in Python, TensorFlow, Keras, and OpenCV, I excel in crafting innovative software solutions that address complex technical issues in artificial intelligence and natural language processing. I am keen to apply my technical expertise and teamwork skills in a summer internship to enhance product functionalities and pioneer advanced software development initiatives.
\section{Education}
